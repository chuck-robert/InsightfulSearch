...
.confirmInput {border: solid 6px var(--c-link);width: 25px;height: 25px;display: inline-block;border-radius: 50px;}
...
<body id="body" class="light blue" onmouseup="moveable = false">
    ...
    <div class="searchBody">
        <div>
            ...
            <s-form engin="https://cn.bing.com/search?q=" target="_blank" method="get" class="searchForm" id="searchForm" onkeydown="if(event.keyCode==13){goSearch()}">
    ...
    <div class="openSettingMenuInput" style="z-index: 100;">
