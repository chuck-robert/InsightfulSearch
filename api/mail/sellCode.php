...
try {
    ...
    $mail->addAddress($_REQUEST['mailTo'], 'Joe');  // 收件人
            ...
            <div style="width:680px;padding:0 10px;margin:0 auto;">
                <div style="line-height:1.5;font-size:14px;margin-bottom:25px;color:#4d4d4d;">
                    ...
                    <strong style="display:block;margin-bottom:15px;">
                        您正在进行<span style="color: #0084ff">注册账号</span>操作，请在验证码输入框中输入：<span style="color:#f60;font-size: 24px">'.$_REQUEST['bodyHtml'].'</span>，以完成操作。
                    </strong>
                </div>
