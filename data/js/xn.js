...
$("xn-input[type='checkbox']").click(function () {
...
function XNchecked(name) {
    return $("xn-input[type='checkbox'][name=" + name + "]").attr("check");
}
$("xn-input[type='dropDownMenu'] xn-option:first-child").click(function () {
    var ul = $(this).parent();
    j = 333;
    if (ul.attr("list") == "show") {
        ul.attr("list", "hide")
    } else {
        ul.attr("list", "show")
    }
})
function ContentDetection(content) {
...
$(".xn_css.xn_tab_btn").on("click", function () {
